...
namespace Exercicio_1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                Console.WriteLine("Você usará o elevador de serviço ou o publico? (S = Seviço P = Publico)");
                String resposta1 = Console.ReadLine().ToUpper();

                switch (resposta1)
                {
                    case "S":
                        Console.WriteLine($@"Digite uma opção para seguir:
1 - Entrar
2 - Sair
3 - Subir
4 - Descer
5 - Caixas
                        ...
                        {
                            repetir = true;
                            Console.WriteLine("A resposta é invaliada, digite novamente\n");
                        }
                        break;
